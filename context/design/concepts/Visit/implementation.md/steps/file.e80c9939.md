...
content_id: e80c9939cd373eb238226784778abf589c9c984e8d2bdf9e510c86c853c7a84a
---
...
export default class VisitConcept {
  ...
  async addEntry(
    ...
    if (existingEntry) {
      return { error: "This exhibit has already been logged for this visit." };
    }
  ...
  async editEntry(
    ...
    if (!entry) {
      return { error: "Visit entry not found." };
    }
