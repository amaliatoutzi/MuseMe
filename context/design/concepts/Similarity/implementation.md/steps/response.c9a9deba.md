---
timestamp: 'Sat Oct 18 2025 19:16:49 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251018_191649.171db5d1.md]]'
content_id: c9a9debab1804bc33a24e58bc3bc55b632b6e9f6c2dbd2f41942956426f17c1c
---
  ...
  async neighbors(
    ...
    try {
      ...
      const results = await this.similarityLinks
        .find({ from: item })
        .sort({ score: -1, to: 1 }) // Sort the results by score in descending order (highest score first, and then to ascending).
